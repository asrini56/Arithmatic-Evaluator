...
public class SqlQueries {
    ...
    public static final String FETCH_TEST_DETAILS_FOR_USER = "SELECT test_id, test_name, tests.grade_id from tests inner join student_to_grade on student_to_grade.grade_id = tests.grade_id inner join users on users.user_id = student_to_grade.user_id where users.email_id=?";
